...
<section class="f--section-primary">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="f--title f--font-primary">Quiénes somos</h1>
        <h2 class="f--tagline f--font-fourth">Fotografía y móvil</h2>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-5 offset-lg-1">
        <div class="position-sticky b--content">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 offset-lg-3 text-center">
        <h3 class="f--font-third f--color-primary text-center f--tagline">“Lo más importante no es la cámara, sino el ojo.”</h3>
        <span class="f--font-fourth f--color-primary text-center"> - Alfred Eisenstaedt - </span>
      </div>
    </div>
  </div>
</section>
